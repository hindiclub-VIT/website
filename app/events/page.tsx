...
export default function EventsPage() {
  ...
  const events = [
    {
      id: 1,
      title: "कविता संध्या - Poetry Evening",
      titleHindi: "कविता संध्या",
      description: "An enchanting evening of Hindi poetry recitation by VIT Bhopal students and faculty members",
      descriptionHindi: "VIT भोपाल के छात्रों और संकाय सदस्यों द्वारा हिंदी कविता पाठ की मनमोहक संध्या",
      date: "2024-02-15",
      time: "6:00 PM",
      venue: "Auditorium A, VIT Bhopal",
      venueHindi: "सभागार A, VIT भोपाल",
      category: "poetry",
      status: "upcoming",
      registrations: 67,
      capacity: 100,
    ...
    {
      id: 2,
      title: "हिंदी दिवस समारोह - Hindi Day Celebration",
      titleHindi: "हिंदी दिवस समारोह",
      description: "Grand celebration honoring our national language with cultural performances and competitions",
      descriptionHindi: "सांस्कृतिक प्रस्तुतियों और प्रतियोगिताओं के साथ राष्ट्रभाषा के सम्मान में भव्य समारोह",
      date: "2024-09-14",
      time: "4:00 PM",
      venue: "Main Auditorium, VIT Bhopal",
      venueHindi: "मुख्य सभागार, VIT भोपाल",
    ...
    {
      id: 3,
      title: "भाषा प्रतियोगिता - Language Competition",
      titleHindi: "भाषा प्रतियोगिता",
      description: "Inter-departmental Hindi language and literature competition testing knowledge and skills",
      descriptionHindi: "अंतर-विभागीय हिंदी भाषा और साहित्य प्रतियोगिता जो ज्ञान और कौशल की परीक्षा करती है",
      date: "2024-01-28",
      time: "2:00 PM",
      venue: "Conference Hall, VIT Bhopal",
      venueHindi: "सम्मेलन हॉल, VIT भोपाल",
    ...
    {
      id: 4,
      title: "साहित्यिक गोष्ठी - Literary Meet",
      titleHindi: "साहित्यिक गोष्ठी",
      description: "Interactive session with renowned Hindi authors and poets discussing contemporary literature",
      descriptionHindi: "प्रसिद्ध हिंदी लेखकों और कवियों के साथ समकालीन साहित्य पर चर्चा करने वाला संवादात्मक सत्र",
      date: "2024-03-10",
      time: "3:00 PM",
    ...
    {
      id: 5,
      title: "सांस्कृतिक संध्या - Cultural Evening",
      titleHindi: "सांस्कृतिक संध्या",
      description: "A vibrant evening showcasing traditional Hindi songs, dance, and theatrical performances",
      descriptionHindi: "पारंपरिक हिंदी गीत, नृत्य और नाट्य प्रस्तुतियों को प्रदर्शित करने वाली जीवंत संध्या",
      date: "2024-04-20",
      time: "7:00 PM",
    ...
    {
      id: 6,
      title: "हास्य कवि सम्मेलन - Comedy Poetry Meet",
      titleHindi: "हास्य कवि सम्मेलन",
      description: "A delightful evening of humor and wit through Hindi comedy poetry and stand-up performances",
      descriptionHindi: "हिंदी हास्य कविता और स्टैंड-अप प्रदर्शन के माध्यम से हास्य और बुद्धि की आनंददायक संध्या",
      date: "2024-01-15",
      time: "6:30 PM",
      venue: "Student Activity Center, VIT Bhopal",
      venueHindi: "छात्र गतिविधि केंद्र, VIT भोपाल",
      category: "entertainment",
      status: "completed",
      registrations: 200,
      capacity: 200,
      image: "/comedy-poetry-banner.png",
      feedbackLink: "https://forms.google.com/comedy-feedback",
      culturalTheme: "😄",
      highlights: ["Comedy Poetry", "Stand-up Acts", "Audience Interaction", "Laughter Therapy"],
      highlightsHindi: ["हास्य कविता", "स्टैंड-अप प्रदर्शन", "दर्शक सहभागिता", "हास्य चिकित्सा"],
      coordinator: "Vikash Kumar",
      coordinatorHindi: "विकाश कुमार",
      prizes: ["Best Comedian Award", "Audience Favorite", "Humor Excellence Certificate"],
    },
  ]
